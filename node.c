...
Node_Edge *Node_edgeHead(Node *this)
{
...
// Lenght of list of neighbors
uint16_t Node_edgeLength(Node *this)
{
   return list_length(this->oneHop);
}

// Add a new Neighbor
void Node_addEdge(Node *this,Node *neighbor)
{
   Node_Edge     *edge;
